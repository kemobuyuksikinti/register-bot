...
client.on("guildMemberAdd", async member => {
  ...
  moment.locale("tr");
  kanal.send("TANIDIĞINI ETİKETLE KAYDOL <@" +member+ ">")
  });
...
client.on("guildMemberAdd", async member => {
  ...
  member.guild.channels.cache.get(`${kanal}`).send(new Discord.MessageEmbed().setColor("RANDOM").setDescription(`${member} sunucuya girdi <@&${rol}> rolü verildi`).setFooter(`kemosalvo`).setTimestamp())
